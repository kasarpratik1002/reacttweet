                        ...
                        <tbody className="myTweetbody">
                            {
                                        ...
                                        <tr key={this.state.tweeet.uuid}>
                                            <td> @{this.state.tweeet.loginId} </td>
                                            ...
                                            <div>
                                                <Form>
                                                    ...
                                                    <Button onClick={() => this.replyTweet(this.state.tweeet.uuid)}>Reply</Button>
                                                </Form>
                                                
                                            </div>
                                            </td>
                                            <td>
                                                <button onClick={ () => this.updateTweet(this.state.tweeet.uuid)} className="btn btn-info">Update </button>
                                                <button style={{ marginLeft: "10px" }} onClick= {() => this.deleteTweet(this.state.tweeet.loginId,this.state.tweeet.uuid)} className="btn btn-danger">Delete </button>
                            ...
                            this.state.replyTweet.map(
                                replyTweet =>
                                    <tr key={replyTweet.uuid}>
                                        <td></td>
                                        <td> <strong>@{replyTweet.loginId}</strong> </td>
